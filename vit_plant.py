...
#格拉姆角场
# data_path = r"C:\Users\林夕\Desktop\Plant_2d_train"
# data1_path = r"D:\植物独立测试集二维数据\Cicer arietinum"
# data2_path = r"D:\植物独立测试集二维数据\Lactuca sativa"
# data3_path = r"D:\植物独立测试集二维数据\Manihot esculenta"
# data4_path = r"D:\植物独立测试集二维数据\Musa acuminata"
# data5_path = r"D:\植物独立测试集二维数据\Nymphaea colorata"

#马尔可夫
data_path = r"D:\MTF_Plant_train"
data1_path = r"C:\MTF_plant\Cicer_arietinum"
data2_path = r"C:\MTF_plant\Lactuca sativa"
data3_path = r"C:\MTF_plant\Manihot esculenta"
data4_path = r"C:\MTF_plant\Musa acuminata"
data5_path = r"C:\MTF_plant\Nymphaea colorata"

# 加载数据集
dataset = datasets.ImageFolder(root=data_path, transform=transform)                                                          #训练集数据
test1_dataset = datasets.ImageFolder(root=data1_path, transform=transform)                                                   #测试集数据
test2_dataset = datasets.ImageFolder(root=data2_path, transform=transform)                                                   #测试集数据
test3_dataset = datasets.ImageFolder(root=data3_path, transform=transform)                                                   #测试集数据
test4_dataset = datasets.ImageFolder(root=data4_path, transform=transform)                                                   #测试集数据
test5_dataset = datasets.ImageFolder(root=data5_path, transform=transform)                                                   #测试集数据
...
test2_loader = DataLoader(test2_dataset, batch_size=32, shuffle=True)
test3_loader = DataLoader(test3_dataset, batch_size=32, shuffle=True)
test4_loader = DataLoader(test4_dataset, batch_size=32, shuffle=True)
test5_loader = DataLoader(test5_dataset, batch_size=32, shuffle=True)
...
# Validate the model
validate_model(net, val_loader)

# Test the model
test_model(net, test1_loader)
test_model(net, test2_loader)
test_model(net, test3_loader)
test_model(net, test4_loader)
test_model(net, test5_loader)